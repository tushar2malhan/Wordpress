...
class MOOAuth_Client {
	...
	private function load_dependencies() {
		...
		//require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public'.DIRECTORY_SEPARATOR.'class-test-public.php';
		$this->loader = new MOOAuth_Client_Loader();
	}


	private function define_admin_hooks() {
		$plugin_admin = new MOOAuth_Client_Admin( $this->get_plugin_name(), $this->get_version() );
