...
function mooauth_client_show_customer_info() {
	...
	<a href="<?php echo esc_url( get_site_url(null, '/wp-admin/').'admin.php?page=mo_oauth_settings&tab=licensing') ?>"><input type="button" class="button button-primary button-large" value="Check Licensing Plans"/></a>
	</td>
	</tr>
	</table>
