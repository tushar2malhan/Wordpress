...
function verify_nonce(){
	if(!isset($_POST['mo_oauth_nonce']) || !wp_verify_nonce(sanitize_text_field($_POST['mo_oauth_nonce']),'mo-oauth-setup-wizard-nonce'))
		wp_send_json('error');	
}

}new MOOAuth_Wizard_Ajax;
?>