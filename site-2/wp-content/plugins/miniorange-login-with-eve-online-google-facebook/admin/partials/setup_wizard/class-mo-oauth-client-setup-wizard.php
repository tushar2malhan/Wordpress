...
class MOOAuth_Client_Setup_Wizard{
	/**
	 * init setup wizard
	 */
	public function page(){
		echo '<head>
		    <meta charset="utf-8">
		    <!-- load dependencies -->';
		    wp_enqueue_style( 'mo_oauth_setup_wizard_style',plugin_dir_url( __FILE__ ) . '/css/generic.css',array(),MO_OAUTH_CSS_JS_VERSION );
			wp_print_styles('mo_oauth_setup_wizard_style');
			wp_enqueue_style( 'mo_oauth_setup_wizard_steps_style',plugin_dir_url( __FILE__ ) . '/css/multi-step.css',array(),MO_OAUTH_CSS_JS_VERSION );
			wp_print_styles('mo_oauth_setup_wizard_steps_style');
			wp_enqueue_style( 'mo_oauth_setup_wizard_font_style',plugin_dir_url( dirname(dirname(dirname(__FILE__ )))) . '/css/font-awesome.css',array(),MO_OAUTH_CSS_JS_VERSION);
			wp_print_scripts('jquery');
			wp_print_scripts('jquery-ui-tooltip');
			wp_print_styles('mo_oauth_setup_wizard_font_style');
			wp_print_styles('dashicons');
			wp_enqueue_script( 'mo_oauth_setup_wizard_script', plugin_dir_url( __FILE__ ) . '/js/generic.js',array(),MO_OAUTH_CSS_JS_VERSION );			
			wp_enqueue_script( 'mo_oauth_setup_wizard_troubleshooting_script', plugin_dir_url( __FILE__ ) . '/js/troubleshooting.js',array(),MO_OAUTH_CSS_JS_VERSION );
