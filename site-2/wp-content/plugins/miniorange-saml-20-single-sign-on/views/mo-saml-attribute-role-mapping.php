...
?>
    <div class="p-4 shadow-cstm bg-white rounded">
            ...
            <div class="col-md-12">
                <h4 class="form-head">
                    <span class="entity-info">Attribute Mapping
                        <a href="https://developers.miniorange.com/docs/saml/wordpress/Attribute-Rolemapping" class="text-dark" target="_blank">
        ...
        <div class="prem-info mt-5 d-block">
            <div class="prem-icn nameid-prem-img sso-btn-prem-img"><img class="crown_img" src="<?php echo esc_url(Utilities::mo_saml_get_plugin_dir_url() . 'images/crown.png') ?>">
                <p class="nameid-prem-text">The basic attributes are configurable in Standard, Premium, Enterprise and All-Inclusive plans. Custom Attributes are configurable in Premium and higher plans. <a href="<?php echo esc_url(admin_url('admin.php?page=mo_saml_settings&tab=licensing')); ?>" class="text-warning">Click here to upgrade</a></p>
            </div>
            <div class="row align-items-top">
                <div class="col-md-3">
        ...
        <div class="align-items-top mt-5 prem-info">
            <div class="prem-icn anonymous-prem-img sso-btn-prem-img"><img class="crown_img" src="<?php echo esc_url(Utilities::mo_saml_get_plugin_dir_url() . 'images/crown.png') ?>">
                <p class="anonymous-text">Enable this option if you want to allow users to login to the WordPress site without creating a WordPress user account for them. <a href="<?php echo esc_url(admin_url('admin.php?page=mo_saml_settings&tab=licensing')); ?>" class="text-warning">Available in Paid Plugin</a></p>
            </div>
...
?>
    <form name="saml_form_am_role_mapping" method="post" action="">
        ...
        <div class="p-4 shadow-cstm bg-white rounded mt-4">
            <div class="row align-items-top">
                <div class="col-md-12">
                    ...
                    <span class="entity-info">Role Mapping
                        <a href="https://developers.miniorange.com/docs/saml/wordpress/Attribute-Rolemapping#Role-Mapping" class="text-dark" target="_blank">
                            <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path>
                                <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"></path>
                            </svg>
            ...
            <div class="align-items-center mt-5"><b>NOTE:</b> Role will be assigned only to new users. Existing WordPress users' role remains same.</div>
            ...
            <div class="prem-info mt-5">
                <div class="prem-icn role-prem-img sso-btn-prem-img"><img class="crown_img" src="<?php echo esc_url(Utilities::mo_saml_get_plugin_dir_url() . 'images/crown.png') ?>">
                    <p class="role-prem-text">Customized Role Mapping options are configurable in the Premium, Enterprise and All-Inclusive versions of the plugin. <a href="<?php echo esc_url(admin_url('admin.php?page=mo_saml_settings&tab=licensing')); ?>" class="text-warning">Click here to upgrade</a></p>
                </div>
            ...
            <div class="d-block prem-info mt-5">
                <div class="prem-icn role-admin-prem-img sso-btn-prem-img"><img class="crown_img" src="<?php echo esc_url(Utilities::mo_saml_get_plugin_dir_url() . 'images/crown.png') ?>">
                    <p class="role-admin-prem-text">Customized Role Mapping options are configurable in the Premium, Enterprise and All-Inclusive versions of the plugin. <a href="<?php echo esc_url(admin_url('admin.php?page=mo_saml_settings&tab=licensing')); ?>" class="text-warning">Click here to upgrade</a></p>
                </div>
                <?php
                ...
                ?>
                    <div class="row align-items-top mt-4">
                        <div class="col-md-3">
                            <h6 class="text-secondary"><?php esc_html_e($role_name, 'miniorange-saml-20-single-sign-on'); ?> :</h6>
                        </div>
                        <div class="col-md-7">
                            <input type="text" name="" placeholder="Semi-colon(;) separated Group/Role value for <?php esc_html_e($role_name, 'miniorange-saml-20-single-sign-on'); ?>" class="w-100 bg-light cursor-disabled" value="" disabled>
                        </div>
                    </div>
                <?php
                }
            ...
            <div>
                <table style="table-layout: fixed;border: 1px solid #fff;width: 100%;background-color: #e9f0ff;">
                    <tr style="text-align:center;background:#d3e1ff;">
                        <td style="font-weight:bold;padding: 2%;word-break: break-word;border:2.5px solid #fff;"><?php esc_html_e('ATTRIBUTE NAME', 'miniorange-saml-20-single-sign-on'); ?></td>
                        <td style="font-weight:bold;padding: 2%;word-break: break-word;border:2.5px solid #fff;"><?php esc_html_e('ATTRIBUTE VALUE', 'miniorange-saml-20-single-sign-on'); ?></td>
                    </tr>
                    <?php foreach ($idp_attrs as $attr_name => $values) {
                        ...
                        <tr style="text-align:center;">
                            <td style="font-weight:bold;border:2.5px solid #fff;padding:2%; word-wrap:break-word;"> <?php esc_html_e($attr_name,'miniorange-saml-20-single-sign-on'); ?></td>
                            <td style="padding:2%;border:2.5px solid #fff; word-wrap:break-word;"> <?php echo wp_kses($attr_values, $allowed_html); ?> </td>
                        </tr>
                    <?php } ?>

                </table>
                <br />
                <p style="text-align:center;"><input type="button" class="btn-cstm rounded mt-3" value="<?php echo esc_attr_x('Clear Attributes List', '','miniorange-saml-20-single-sign-on'); ?>" onclick="document.forms['attrs_list_form'].submit();"></p>
