...
function mo_saml_apps_config_saml()
{
    ...
    if (!empty($mo_saml_identity_provider_identifier_name)) {
        ...
        if (array_key_exists($mo_saml_identity_provider_identifier_name, mo_saml_options_plugin_idp::$IDP_GUIDES)) {
            ...
            $idp_data->image_src = Utilities::mo_saml_get_plugin_dir_url() . 'images/idp-guides-logos/' . $idp_key . '.png';
...
{
?>
    <div class="pt-3 pe-5 pb-5 ps-5 shadow-cstm bg-cstm rounded">
        ...
        <div class="row">
            <div class="col-md-12 text-center rounded mo-saml-scroll-cstm pb-2">
                <div class="row justify-content-center pb-2" id="mo_saml_idps_grid_div">
                    ...
                    ?>
                        <div class="col-md-2 logo-saml-cstm" data-idp="<?php esc_attr_e($idp_video_index, 'miniorange-saml-20-single-sign-on'); ?>">
                            <a target="_blank" data-idp-value="<?php esc_attr_e($idp_video_index, 'miniorange-saml-20-single-sign-on'); ?>" data-href="https://plugins.miniorange.com/<?php esc_attr_e($value[1], 'miniorange-saml-20-single-sign-on'); ?>" data-video="https://www.youtube.com/watch?v=<?php esc_attr_e($idp_video_index,'miniorange-saml-20-single-sign-on'); ?>">
                                <img loading="lazy" width="30px" src="<?php echo esc_url(plugins_url($image_path . $value[0] . '.png', __FILE__)); ?>">
                                <br>
                                <h6 class="mt-2"><?php esc_html_e($key, 'miniorange-saml-20-single-sign-on'); ?></h6>
                            </a>
                        </div>
                    <?php } ?>
                </div>
    ...
    <input type="hidden" name="idp_specific_ads" id="idp_specific_ads" value='<?php esc_attr_e(json_encode(mo_saml_options_plugin_idp_specific_ads::$idp_specific_ads),'miniorange-saml-20-single-sign-on'); ?>' />
<?php
}
...
?>
    <div class="p-4 shadow-cstm bg-white rounded mt-4" id="idp_scroll_saml">
            ...
            <div class="col-md-12">
                <h4 class="form-head">
                    <span class="entity-info">Configure Service Provider
                        <a href="https://developers.miniorange.com/docs/saml/wordpress/Service-Provider-Setup" class="text-dark" target="_blank">
        ...
        <div class="row align-items-center mt-5 mb-5" id="mo_saml_selected_idp_div" style="display: none;">
            ...
            <div class="col-md-4">
                <a target="_blank" href="" id="saml_idp_guide_link" class="text-white px-4 py-2 rounded bg-info"><svg width="16" height="16" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
                        <path d="M.102 2.223A3.004 3.004 0 0 0 3.78 5.897l6.341 6.252A3.003 3.003 0 0 0 13 16a3 3 0 1 0-.851-5.878L5.897 3.781A3.004 3.004 0 0 0 2.223.1l2.141 2.142L4 4l-1.757.364L.102 2.223zm13.37 9.019.528.026.287.445.445.287.026.529L15 13l-.242.471-.026.529-.445.287-.287.445-.529.026L13 15l-.471-.242-.529-.026-.287-.445-.445-.287-.026-.529L11 13l.242-.471.026-.529.445-.287.287-.445.529-.026L13 11l.471.242z" />
                    </svg> &nbsp;Setup Guide</a>
            </div>
            <div class="col-md-4">
                <a target="_blank" href="" id="saml_idp_video_link" class="text-white px-4 py-2 rounded bg-danger"><svg width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
        ...
        <div class="mo-saml-sp-tab-container mt-4">
            <ul class="switch-tab-sp text-center">
            ...
            <div class="mo-saml-sp-tab">
                ...
                <form method="post" action="">
                    ...
                    <div id="mo-saml-idp-manual-tab" class="mo-saml-tab-content">
                        <input type="hidden" name="mo_saml_identity_provider_identifier_name" id="mo_saml_identity_provider_identifier_name" value="<?php esc_attr_e($mo_saml_identity_provider_identifier_name, 'miniorange-saml-20-single-sign-on'); ?>" />
                        ...
                        <div class="row align-items-top mt-5">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="saml_identity_name" placeholder="Identity Provider name like ADFS, SimpleSAML, Salesforce" class="w-100" value="<?php esc_attr_e($saml_identity_name,'miniorange-saml-20-single-sign-on'); ?>" required title="Only alphabets, numbers and underscore is allowed" pattern="\w+">
                            </div>
                        </div>
                        <div class="row align-items-top mt-5">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-7">
                                <input type="text" title="Please enter a valid value" name="saml_issuer" id="saml_issuer" pattern="[^\s]+\s*$" placeholder="Identity Provider Entity ID or Issuer" class="w-100" value="<?php esc_attr_e($saml_issuer, 'miniorange-saml-20-single-sign-on'); ?>" required="">
                        ...
                        <div class="row align-items-top mt-5">
                            ...
                            <div class="col-md-7">
                                <input type="url" title="Please enter a valid value" name="saml_login_url" pattern="[^\s]+\s*$" placeholder="Single Sign On Service URL (HTTP-Redirect binding) of your IdP" class="w-100" value="<?php esc_attr_e($saml_login_url, 'miniorange-saml-20-single-sign-on'); ?>" required="">
                        ...
                        ?>
                            <div class="row align-items-top mt-5">
                                ...
                                <div class="col-md-7">
                                    <textarea rows="4" cols="5" name="saml_x509_certificate[<?php esc_attr_e($key, 'miniorange-saml-20-single-sign-on'); ?>]" id="saml_x509_certificate" onkeyup="removeCertificateErrorClass();" placeholder="Copy and Paste the content from the downloaded certificate or copy the content enclosed in X509Certificate tag (has parent tag KeyDescriptor use=signing) in IdP-Metadata XML file" class="w-100" required=""><?php esc_html_e($value, 'miniorange-saml-20-single-sign-on'); ?></textarea>
                        ...
                        <div class="row align-items-top mt-5">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="checkbox" id="switch" name="mo_saml_encoding_enabled" class="mo-saml-switch" <?php esc_attr_e($saml_is_encoding_enabled, 'miniorange-saml-20-single-sign-on'); ?> /><label class="mo-saml-switch-label" for="switch">Toggle</label>
                        ...
                        <div class="row align-items-top mt-2">
                            ...
                            <div class="col-md-9">
                                <input type="submit" class="mo-saml-bs-bs-btn btn-cstm rounded mt-3 me-3 w-176" name="submit" value="Save">
                                <input type="button" class="mo-saml-bs-bs-btn btn-cstm rounded mt-3 w-176" id="test_config" <?php if (!Utilities::mo_saml_is_sp_configured() || !get_option('saml_x509_certificate') || !mo_saml_is_openssl_installed())
                        ...
                        <div class="row align-items-top mt-2">
                            <div class="col-md-3"></div>
                            <div class="col-md-9">
                                <input type="button" class="mo-saml-bs-bs-btn btn-cstm rounded mt-3 w-372" name="saml_request" id="export-import-config" <?php if (!Utilities::mo_saml_is_sp_configured() || !get_option('saml_x509_certificate')) {
                                                                                                                                                echo 'disabled';
