...
if (portfolioPostsBtn){
    ...
    portfolioPostsBtn.addEventListener("click", function() {
        console.log('button clicked in 8001 ')
...
if (quickAddbButton) {
    ...
    quickAddbButton.addEventListener("click", function() {
        ...
        // using wp_remote_post send ourPostData to the server 8000
        wp_remote_post('http://localhost:8000/wp-json/wp/v2/posts',ourPostData); 
